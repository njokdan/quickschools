...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2018 at 02:10 PM
...
CREATE TABLE IF NOT EXISTS `assignschool` (
...
CREATE TABLE IF NOT EXISTS `assign_subject_to_student` (
...
CREATE TABLE IF NOT EXISTS `classx` (
...
(1, 0, 'images/nwa.jpg', '01-05-2018'),
(2, 0, 'images/nwa.jpg', '01-05-2018'),
(3, 0, 'images/gety.jpg', '01-05-2018'),
(4, 25, 'images/nwa.jpg', '01-05-2018'),
(5, 1, 'images/ceo.jpg', '02-05-2018');
...
CREATE TABLE IF NOT EXISTS `pick_subject_for_student` (
  `subjectid` bigint(4) NOT NULL AUTO_INCREMENT,
  `staffid` bigint(4) NOT NULL,
  `studentid` bigint(4) NOT NULL,
  `subject` varchar(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `staff_comment` (
